...
class MapFeatureExtractor(nn.Module):
    ...
    def __init__(
        ...
        Parameters:
            ...
            memory_efficient: Whether to use checkpointing for memory efficiency.
            transpose_conv: Whether to use transpose convolutions for upsampling (decoder).
        """
        super().__init__()
        ...
        self.conv_first = nn.Conv2d(
            ...
            stride=1,
            padding=1,
        ) if not transpose_conv else nn.ConvTranspose2d(
            in_channels=in_channels,
            out_channels=num_channels,
            kernel_size=3,
            stride=2,
        ...
        # ^-- the above parameters 2x the input size
        self.gelu = nn.GELU()
